...
import android.weds.lip_library.util.UIHelper;
...
//                        UIHelper.sendAppCrashReport(context);
    ...
    private boolean saveToSDCard(Throwable ex) throws Exception {
        ...
        File file = FileUtils.getSaveFile("wedsException", "weds.log");//TODO
        ...
        // 导出发生异常的时间
        pw.println(Dates.newDateStringOfFormatDateTime());
        // 导出手机信息
        dumpPhoneInfo(pw);
        pw.println();
        // 导出异常的调用栈信息
