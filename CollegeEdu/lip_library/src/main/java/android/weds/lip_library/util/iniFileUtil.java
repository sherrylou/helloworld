...
public class iniFileUtil {
    ...
    public void save(File file) {
        ...
        if (flag == 1) {
            //chmod -R 777 / mnt / app / variable
            try {
                Log.i("ini文件", "=======赋权限=========");
                String[] chmodStr = {"su", "-c", "chmod -R 777 /mnt/app/variable"};
                Process chmodProcess = Runtime.getRuntime().exec(chmodStr);
    ...
    private void initFromFile(File file) {
        ...
        try {
            ...
            LogUtils.e("初始化从文件初始化IniFile异常", "===========" + e.getMessage() + "===========");
            e.printStackTrace();
        }
    }
        ...
        try {
            ...
            for (Section section : sections.values()) {
                ...
                for (Map.Entry<String, Object> entry : section.getValues().entrySet()) {
                    Log.i("往ini文件中存储", entry.getKey() + "---" + entry.getValue().toString());
