 ...
 * <p>
 * 自定义支持viewgroup的RadioGroup
 */

public class RadioGroupWithGroup extends LinearLayout {
    ...
    private RadioGroupWithGroup.OnCheckedChangeListener mOnCheckedChangeListener;
    private PassThroughHierarchyChangeListener mPassThroughListener;

    /**
     * {@inheritDoc}
     */
    public RadioGroupWithGroup(Context context) {
        super(context);
     ...
     * {@inheritDoc}
     */
    public RadioGroupWithGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
     ...
     */
    public void setOnCheckedChangeListener(RadioGroupWithGroup.OnCheckedChangeListener listener) {
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(RadioGroupWithGroup group, @IdRes int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == RadioGroupWithGroup.this && child instanceof RadioButton) {
                int id = child.getId();
            ...
            }else if (parent == RadioGroupWithGroup.this   //这里是我添加的代码
        ...
        public void onChildViewRemoved(View parent, View child) {
            ...
            }else if (parent == RadioGroupWithGroup.this
                    && child instanceof ViewGroup) {
